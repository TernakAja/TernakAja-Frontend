    ...
    <footer className="bg-[#328E6E] text-white">
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <h3 className="text-2xl font-bold mb-4">TernakAja</h3>
            <p className="mb-4 text-[#E1EEBC]">{t("footer.title")}</p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a
                  href="/"
                  className="text-[#E1EEBC] hover:text-white transition-colors"
                >
                  {t("footer.quick.home")}
                </a>
              </li>
        ...
        <div className="border-t border-white/20 mt-12 pt-6 text-center text-[#E1EEBC]">
          <p>© {new Date().getFullYear()} TernakAja. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
