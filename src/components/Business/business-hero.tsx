      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <h1 className="text-5xl md:text-6xl font-bold mb-6 leading-tight">
            Partner with
            <span className="block text-[#E1EEBC]">TernakAja</span>
          </h1>

          <p className="text-xl md:text-2xl mb-8 text-white/90 leading-relaxed">
            Join the revolution in livestock monitoring technology. Explore our
            comprehensive business model and discover partnership opportunities
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <Button
              size="lg"
              className="bg-white text-[#328E6E] hover:bg-gray-100 font-semibold"
            >
