        ...
        <Tabs defaultValue="guides">
          ...
          <TabsContent value="guides" className="space-y-4">
            <div className="bg-[#E1EEBC]/20 rounded-lg p-3 cursor-pointer hover:bg-[#E1EEBC]/30">
              ...
              <p className="text-sm text-gray-600 mt-1">
                Complete guide to setting up your first livestock monitoring
                system
              </p>
            </div>
            <div className="bg-[#E1EEBC]/20 rounded-lg p-3 cursor-pointer hover:bg-[#E1EEBC]/30">
              ...
              <p className="text-sm text-gray-600 mt-1">
                Understanding vital signs and health indicators
              </p>
            </div>
            <div className="bg-[#E1EEBC]/20 rounded-lg p-3 cursor-pointer hover:bg-[#E1EEBC]/30">
              <h3 className="font-medium text-[#328E6E]">Seasonal Care</h3>
              <p className="text-sm text-gray-600 mt-1">
                Adapting livestock management to seasonal changes
              </p>
            </div>
            <div className="bg-[#E1EEBC]/20 rounded-lg p-3 cursor-pointer hover:bg-[#E1EEBC]/30">
              <h3 className="font-medium text-[#328E6E]">Device Maintenance</h3>
              <p className="text-sm text-gray-600 mt-1">
                Keeping your TernakAja devices in optimal condition
              </p>
            </div>
          </TabsContent>
          ...
          <TabsContent value="faq" className="space-y-4">
            <div className="border-b border-gray-200 pb-3">
              ...
              <p className="text-sm text-gray-600 mt-1">
                TernakAja collars typically last 2-3 weeks on a single charge,
                depending on usage.
              </p>
            </div>
            <div className="border-b border-gray-200 pb-3">
              <h3 className="font-medium text-[#328E6E]">
                What's the range of the collar?
              </h3>
              <p className="text-sm text-gray-600 mt-1">
                The standard range is up to 5 miles in open terrain, less in
            ...
            <div className="border-b border-gray-200 pb-3">
              ...
              <p className="text-sm text-gray-600 mt-1">
                Yes, TernakAja collars are IP67 rated, making them fully
                waterproof in up to 1 meter of water.
              </p>
            </div>
            <div className="border-b border-gray-200 pb-3">
              <h3 className="font-medium text-[#328E6E]">
                How accurate is the health monitoring?
              </h3>
              <p className="text-sm text-gray-600 mt-1">
                Our sensors are 95-98% accurate compared to veterinary equipment
                in controlled tests.
              </p>
            </div>
          </TabsContent>
