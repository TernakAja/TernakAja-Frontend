...
export default function LoginForm() {
  ...
  return (
    ...
    >
      <h2 className="text-2xl font-semibold text-[#328E6E] mb-6">Log in to your account</h2>
      ...
      <div className="mt-6 text-center text-sm text-gray-600">
        ...
        <motion.span whileHover={{ scale: 1.05 }}>
          <Link to="/register" className="text-[#328E6E] hover:text-[#67AE6E] hover:underline">
            Sign Up
          </Link>
        </motion.span>
      </div>
